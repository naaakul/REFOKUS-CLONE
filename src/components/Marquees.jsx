...
const Marquees = () => {
  ...
  return <div className="relative py-20 mt-20">
    {images.map((item, index) => <Marquee direction={index % 2 === 0 ? "left" : "right"} key={index} urls={item} />)}
    <div className='absolute top-1/2 -translate-y-1/2 left-0 h-2/3 w-full bg-gradient-to-r from-[#000000] via-transparent to-[#000000]'></div>
  </div>;
};
